...
(function (factory) {
    ...
    FileInput.prototype = {
            ...
            self.previewCache = {
                ...
                footer: function (i, isDisabled, size) {
                    ...
                    var config = data.config[i], caption = $h.ifSet('caption', config), actions,
                        ...
                        filenameurl = $h.ifSet('filenameUrl', config, false);
                    actions = self._renderFileActions(false, showDel, showZoom, showDrag, disabled, url, key, true, filenameurl);
        ...
        _renderFileFooter: function (caption, size, width, isError) {
            ...
            if (self.isUploadable) {
                out = template.setTokens({
                    'actions': self._renderFileActions(upl, rem, zoom, drg, false, false, false, false),
                    'caption': caption,
                    'size': size,
                    'width': width,
                    'progress': self._renderThumbProgress(),
                ...
                out = template.setTokens({
                    'actions': self._renderFileActions(false, false, zoom, drg, false, false, false, false),
                    'caption': caption,
                    'size': size,
                    'width': width,
                    'progress': '',
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit, filenameurl) {

            if (!showUpload && !showDelete && !showZoom && !showDrag) {
                return '';
            }
            var self = this;
            var vFilenameUrl = filenameurl === "" ? '' : 'onclick=setdefault(\'' + filenameurl + '\')';
            ...
            if (showDrag && isInit) {
                ...
                otherButtons = self.otherActionButtons.setTokens({ 'dataKey': vKey, 'setDefault': vFilenameUrl });
            }
