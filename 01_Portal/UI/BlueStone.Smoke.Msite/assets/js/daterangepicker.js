        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template  = '<div class="daterangepicker dropdown-menu">' +
                                    ...
                                    '<div class="calendar left">' +
                                    		'<div class="prev_year"><i class="iconfont icon-left1"></i></div>'+
                                        '<div class="calendar-table">'+
                                        '</div>' +
                                    '</div>' +
                                    '<div class="calendar right">' +
                                    		'<div class="prev_month"><i class="iconfont icon-right1"></i></div>'+
...
//      	//console.log('我是第6个方法');
            ...
            if ((!minDate || minDate.isBefore(calendar.firstDay)) && (!this.linkedCalendars || side == 'left')) {
                html += '<th class="prev available"><i class="iconfont icon-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if ((!maxDate || maxDate.isAfter(calendar.lastDay)) && (!this.linkedCalendars || side == 'right' || this.singleDatePicker)) {
                html += '<th class="next available"><i class="iconfont icon-right"></i></th>';
            } else {
                html += '<th></th>';
            }
