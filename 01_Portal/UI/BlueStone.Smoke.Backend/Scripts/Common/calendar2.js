var calUtil = {
  ...
  init: function () {
    ...
    calUtil.bindEnvent(calUtil.signList);
  },
  ...
  bindEnvent:function(signList){
      ...
      $(".fa-chevron-left").click(function () {
          ...
          calUtil.setMonthAndDay();
          if (calUtil.callback) {
              calUtil.callback(calUtil.showYear, calUtil.showMonth);
          }
  ...
  drawCal : function(iYear, iMonth ,signList) {
   ...
   htmls.push("<i class=\"fa  fa-chevron-left\" style='float:left;font-size:18px;margin-top:10px;cursor:pointer; margin-left:10px;'></i><div class='calendar_month_span'></div><i class=\"fa  fa-chevron-right\" style='float:right;font-size:18px;margin-top:10px;cursor:pointer;margin-right:10px;'></i>");
   htmls.push("</div>");
