...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            options.ranges = $.extend(this.ranges, options.ranges);
            ...
            if (!this.timePicker && this.startDate != null && this.endDate != null) {
            ...
            if (this.startDate != null) {
                ...
                var s = moment().subtract('days', 29);
                this.leftCalendar = {
                    month: moment([s.year(), s.month(), 1, s.hour(), s.minute()]),
                    calendar: []
                };
            }
        ...
        updateView: function () {
            if (this.startDate != null) {
                ...
                this.leftCalendar.month.month(moment().month()).year(moment().year());
            }
            if (this.endDate != null) {
        ...
        updateInputText: function() {
            if (this.element.is('input') && !this.singleDatePicker) {
                ...
                .attr('startDate', this.startDate.format(this.format))
                .attr('endDate', this.endDate.format(this.format));
        ...
        updateCalendars: function () {
            ...
            for (var range in this.ranges) {
                if (this.timePicker) {
                    if (his.startDate && this.startDate.isSame(this.ranges[range][0]) && this.endDate.isSame(this.ranges[range][1])) {
                        customRange = false;
    ...
    $.fn.daterangepicker = function (options, cb) {
        ...
        this.each(function () {
            ...
            if (!data) {
                data = new DateRangePicker(el, options, cb);
                el.data('daterangepicker', data);
            }
